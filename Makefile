...
PLIPBOX13_SKIP_CIA_ICR ?= 0
PLIPBOX13_ATTACH_STAGE ?= 6
PLIPBOX13_SKIP_MISC_ALLOC ?= 1
PLIPBOX13_SKIP_MAGIC ?= 0
PLIPBOX13_DIRECT_HWSEND ?= 0
PLIPBOX13_C_SEND ?= 1
PLIPBOX13_RX_WAKE_TICKS ?= 8
PLIPBOX13_RX_WAKE_POLLS ?= 8
PLIPBOX13_RX_TASK_PRI ?= 25
...
CPPFLAGS += \
	...
	-DPLIPBOX13_RX_WAKE_TICKS=$(PLIPBOX13_RX_WAKE_TICKS) \
	-DPLIPBOX13_RX_WAKE_POLLS=$(PLIPBOX13_RX_WAKE_POLLS) \
	-DPLIPBOX13_RX_TASK_PRI=$(PLIPBOX13_RX_TASK_PRI)
